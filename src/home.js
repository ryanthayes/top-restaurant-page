...
export default function home() {
    ...
    const heroContainer = createHtmlElement('div', null, ['container--small'], null, hero);
    ...
    const primaryBtn = createHtmlElement('button', 'reservationsHeroBtn', ['btn'], 'Book a Table', btnContainer);
    const secondaryBtn = createHtmlElement('button', 'menuBtn', ['btn', 'btn--secondary'], 'Explore Our Menu', btnContainer);
